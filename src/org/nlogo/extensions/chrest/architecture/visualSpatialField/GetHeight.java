 ...
 */
public class GetHeight extends DefaultReporter {
   ...
   * jchrest.architecture.VisualSpatialField#getHeight()} on the {@link 
  ...
  public Object report(Argument[] args, Context context) throws ExtensionException, LogoException {
    return (double)((VisualSpatialField)args[0].get()).getHeight();
  }
