 ...
 */
public class GetMinimumItemOrPositionOccurrencesInNodeImagesToBeSlotValue extends DefaultReporter {
  ...
  public Object report(Argument[] argmnts, Context cntxt) throws ExtensionException, LogoException {
    return ChrestExtension.getTurtlesChrestInstance(cntxt).getMinItemOrPositionOccurrencesToBeSlotValue();
  }
