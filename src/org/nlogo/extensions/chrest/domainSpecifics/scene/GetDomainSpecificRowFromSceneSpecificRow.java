 ...
 */
public class GetDomainSpecificRowFromSceneSpecificRow extends DefaultReporter{
   ...
   * jchrest.domainSpecifics.Scene#getDomainSpecificRowFromSceneSpecificRow(int)
   * }.
   * @param context
   * 
   * @return The result of invoking {@link 
   * jchrest.domainSpecifics.Scene#getDomainSpecificRowFromSceneSpecificRow(
