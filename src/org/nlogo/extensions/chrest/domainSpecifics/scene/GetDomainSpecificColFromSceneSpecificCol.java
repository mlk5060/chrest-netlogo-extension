 ...
 */
public class GetDomainSpecificColFromSceneSpecificCol extends DefaultReporter {
   ...
   * jchrest.domainSpecifics.Scene#getDomainSpecificColFromSceneSpecificCol(int)
   * }.
   * @param context
   * 
   * @return The result of invoking {@link 
   * jchrest.domainSpecifics.Scene#getDomainSpecificColFromSceneSpecificCol(
