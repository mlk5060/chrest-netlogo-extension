 ...
 */
public class Test4 extends DefaultReporter {
  ...
  public Object report(Argument[] args, Context context) throws ExtensionException, LogoException {
    ...
    try {
      ...
      AheadOfAgentFixation fixation = new AheadOfAgentFixation(0);
      ...
      //Need to add the visual LTM root Node so grant access to it.
      Field chrestVisualLtmRootNodeField = Chrest.class.getDeclaredField("_visualLtm");
      chrestVisualLtmRootNodeField.setAccessible(true);
      
      //Add the Node to Visual STM at a time when its slots are filled, i.e. 1.
      ArrayList<Node> visualStmState = new ArrayList();
      visualStmState.add((Node)chrestVisualLtmRootNodeField.get(turtlesModel));
